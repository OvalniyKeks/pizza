<template>
  <div class="header-bottom">
    <NuxtLink to="/" class="flex align-center">
    ...
    <Button orange class="mobile-hide" @click="isModalCart = !isModalCart">
      <img src="~assets/images/icon/global/cart.svg" />
      {{ currPrice }} ₽
    </Button>

    <Modal v-model="isModalCart" align="right">
      <CartModal />
    </Modal>

    <Button width="32px" class="desktop-hide" @click="toggleMenuMobile">
      <div class="header-burger" :class="{ active: menuMobile }">
        <div></div>
        <div></div>
        <div></div>
      </div>
